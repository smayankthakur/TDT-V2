        ...
        <div className="mt-16 pt-8 border-t border-border/20">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} Divine Tarot. All rights reserved. Crafted with 
              <Heart className="inline h-3 w-3 mx-1 text-rose-400" />
              for seekers.
            </p>
            <div className="flex gap-6">
              <Link href="https://www.sitelytc.com/" className="text-xs text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
                Designed by Sitelytc Digital Media
              </Link>
            </div>
          </div>
        </div>
